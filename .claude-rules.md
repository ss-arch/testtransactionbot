...
### Code Optimization
- **Always optimize when making changes**: Refactor duplicated code, improve performance, simplify complex logic
- **DRY principle**: Extract common patterns into helper functions
- **Performance**: Use efficient data structures, minimize API calls, cache when appropriate
- **Readability**: Clear variable names, logical structure, remove dead code
- **Resource efficiency**: Reuse aiohttp sessions, batch operations where possible
...
### When User Says
- **"deploy"** → Update and restart server immediately
- **"push to github"** → Commit and push current changes
- **"change X to Y"** → Make change, commit, push, deploy
- **"how to..."** → Brief explanation with commands
- **"show me..."** → Display requested information directly
...
2. **Complete the chain**: Change → Commit → Push → Deploy → Verify
...
9. **OPTIMIZE EVERY TIME**: Always perform code optimization during any code changes. Look for opportunities to improve performance, reduce duplication, simplify logic, and enhance readability.
